...
@section('content')
                    ...
                    <div class="row no-gutters align-items-center">
                        <div class="col mr-2">
                            <div class="text-xs font-weight-bold text-success text-uppercase mb-1">
                                Baterai GS</div>
                            <div class="h5 mb-0 font-weight-bold text-gray-800">{{ $gs }}</div>
                        </div>
                        <div class="col-auto">
        ...
        <div class="col-xl-3 col-md-6 mb-4">
            <div class="card border-left-info shadow h-100 py-2">
                <div class="card-body">
                    <div class="row no-gutters align-items-center">
                        <div class="col mr-2">
                            <div class="text-xs font-weight-bold text-info text-uppercase mb-1">Batarai Vitra
                            </div>
                            <div class="row no-gutters align-items-center">
                                <div class="col-auto">
                                    <div class="h5 mb-0 mr-3 font-weight-bold text-gray-800">{{ $vitra }}</div>
                                </div>
                                <div class="col">
                    ...
                    <div class="row no-gutters align-items-center">
                        <div class="col mr-2">
                            <div class="text-xs font-weight-bold text-warning text-uppercase mb-1">
                                Baterai Incoe</div>
                            <div class="h5 mb-0 font-weight-bold text-gray-800">{{ $incoe }}</div>
                        </div>
                        <div class="col-auto">
    ...
    <div class="row">
        ...
        <div class="row">
            ...
            <!-- Pie Chart -->
            <div class="col-xl-4 col-lg-5 " style="max-width: auto;max-height:auto;">
                <div class="card shadow mb-4 ">
                    <!-- Card Header - Dropdown -->
                    <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                    ...
                    <div class="container">
                        <div class="card-body">
                            ...
                            <div class="mt-4 text-justify small">
                                <span class="mr-2">
                                ...
                                <span class="mr-2">
                                    <i class="fas fa-circle text-secondary"></i> penjualan
                                </span>
                            </div>
                        </div>
                    </div>
